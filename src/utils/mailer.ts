...
const adminEmail : string = 'Replace this string with your email admin address.'
const adminPassword : string = 'Replace this string with your email admin password.'
